"""
LLM Judge for LoCoMo benchmark evaluation.
Adapted from mem0ai/mem0 evaluation code.
Uses DeepSeek as the judge model.
"""
...
def main():
    """Main function to evaluate results using LLM judge."""
    parser = argparse.ArgumentParser(description="Evaluate results using LLM judge")
    parser.add_argument(
        "--input_file",
        type=str,
